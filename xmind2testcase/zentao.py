...
def xmind_to_zentao_csv_file(xmind_file):
    ...
    fileheader = ["所属模块", "用例标题", "Api_URL","请求头", "请求体", "预期返回body", "关键词", "优先级", "用例类型", "适用阶段"]
...
def gen_a_testcase_row(testcase_dict):
    ...
    # 添加新字段请求头，对应summary为xmind中用例级别的批注
    case_comments = testcase_dict['summary']  # 请求头
    # 修改前
    # case_apply_phase = '迭代测试'
    # 修改后
    case_apply_phase = '单元测试阶段'
    row = [case_module, case_title, case_precontion, case_comments, case_step, case_expected_result, case_keyword, case_priority,
